...
const accordionData = [
  {
    ...
    content:
      '네, 본인명의의 휴대폰이 아니더라도 대체 인증 수단을 이용해 금융상품에 가입할 수 있습니다.',
  },
  {
    title: '가입 가능한 국가는 어디인가요?',
    content:
      '2024년 3월 13일 기준, 16개국이 가입 가능하며, 국가는 아래와 같습니다: 캄보디아, 사우디아라비아, 태국, 베트남, 일본, 중국, 대만, 스위스, 헝가리, 나이지리아, 인도, 미얀마, 독일, 영국, 프랑스, 미국.',
  },
  {
    title: '직접 상담 받고 싶은데 영업점은 어떻게 운영하나요?',
    content:
      '직접 상담을 원하시면 가까운 영업점에 방문하여 상담을 받을 수 있습니다. 운영 시간과 예약 가능 여부는 각 영업점에 문의하세요.',
  },
]
